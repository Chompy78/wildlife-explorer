...
export function CamperScreen({ saveData, onSaveChange, onReturnToPark, onTravelToForest, onGoHome }: Props) {
  ...
  return (
    <main className="screen camper-screen">
      ...
      <section className="biome-visual panel"><img src={assetUrl('assets/wild-camper/wild-camper-direction.png')} alt="Illustrated Wild Camper parked in a natural landscape"/><div className="biome-visual-copy"><p className="eyebrow">Unlocked base</p><h2>Inside the Wild Camper</h2><p>Inspect stations, review discoveries, and plan the next journey.</p></div></section>
