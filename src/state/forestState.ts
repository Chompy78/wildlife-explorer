...
export const forestAnimalIds: AnimalId[] = ['forest-wren', 'forest-wallaby', 'forest-beetle'];
...
export function photographForestAnimal(save: SaveData, id: AnimalId): SaveData { if (!forestAnimalIds.includes(id)) return save; return { ...save, discoveredAnimals: [...new Set([...save.discoveredAnimals,id])], photographedAnimals: [...new Set([...save.photographedAnimals,id])] }; }
